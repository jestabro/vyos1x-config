...
val set_path : int -> string list -> int -> int
val delete_path : int -> string list -> int -> int
val set_path_reversed : int -> string list -> int -> int
val delete_path_reversed : int -> string list -> int -> int
